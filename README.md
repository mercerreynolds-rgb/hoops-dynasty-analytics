...
## v8 diagnostics/rebuild

Adds:
- /diagnostics page
- team/count visibility
- Rebuild lineup/impact tables button
- automatic rebuild on /season if imported stats exist but impact tables are empty


## v10 coaching decisions

Adds:
- Best lineups with default 20-possession threshold
- Last 5 game player form
- Wins vs losses split
- Human-controlled vs Sim AI opponent split
- Opponent coach capture from game header

Important: because v10 adds coach fields to the Game table, reset database and re-import games after deploying.
