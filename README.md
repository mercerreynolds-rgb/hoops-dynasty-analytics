...
## v48 browser-authenticated archive crawler

Changes archive import to use Playwright/rendered DOM by default:
- avoids 403 Clerk/OAuth redirect from raw requests
- extracts pid links from rendered page links/attributes
- logs ARCHIVE ROSTER RENDERED PARSER DEBUG
- raw requests fallback remains available by unchecking Browser-rendered crawl
