...
## Stable Projection Engine v1

Adds:
- /projections board
- /projections/{player_id} editable projection detail
- manual potential color labels per rating
- development/minutes tier selector
- seasons-in-program selector
- deterministic projected ratings and OVR
- first Season Start baseline only
- all ratings capped at 100
