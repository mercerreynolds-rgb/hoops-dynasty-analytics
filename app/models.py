...
class PlayerProjectionProfile(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    ...
    seasons_in_program: int = 4
    development_tier: str = "black"

    athleticism_color: str = "black"
    speed_color: str = "black"
    rebounding_color: str = "black"
    defense_color: str = "black"
    shot_blocking_color: str = "black"
    low_post_color: str = "black"
    perimeter_color: str = "black"
    ball_handling_color: str = "black"
    passing_color: str = "black"
    stamina_color: str = "black"
    durability_color: str = "black"
    free_throw_color: str = "black"
