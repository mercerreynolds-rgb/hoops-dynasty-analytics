...
from app.config import TRACKED_TEAMS, DEFAULT_TEAM, DEFAULT_WORLD, SYNC_TARGETS
...
def dashboard(request: Request, session: Session = Depends(get_session)):
    ...
    return templates.TemplateResponse(
        "dashboard.html",
        {"request": request, "games": games, "teams": get_tracked_team_options(), "sync_targets": get_sync_targets(), "wis_auth": wis_auth_status()},
    )
